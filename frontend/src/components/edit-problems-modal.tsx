...
interface EditProblemModalProps {
  problem: ProblemsResponse;
  trigger: React.ReactNode;
}

export function EditProblemModal({ trigger, problem }: EditProblemModalProps) {
  const [open, setOpen] = useState(false);
  const { editProblem } = useProblems();

  const [form, setForm] = useState<Partial<ProblemsResponse>>(problem);
        ...
        <DialogHeader className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription>Edit your problem entry</DialogDescription>
            </div>
          </div>
        </DialogHeader>
